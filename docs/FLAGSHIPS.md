...
| [Shed](https://github.com/CasterlyGit/shed) | Applied AI / developer tools | Local context retrieval plus queued, human-reviewed memory proposals | [Status, setup, and limits](https://github.com/CasterlyGit/shed/blob/7d3d79d2a662ecf0f61195c0b0620f454b2178ed/README.md) · [design](https://github.com/CasterlyGit/shed/blob/7d3d79d2a662ecf0f61195c0b0620f454b2178ed/docs/DESIGN.md) · [tests](https://github.com/CasterlyGit/shed/tree/7d3d79d2a662ecf0f61195c0b0620f454b2178ed/tests) |
| [emergency-ai](https://github.com/CasterlyGit/emergency-ai) | Backend / platform | Offline-first PWA behavior paired with a FastAPI service, retrieval, caching, metrics, and explicit privacy boundaries | [Status and setup](https://github.com/CasterlyGit/emergency-ai/blob/0cadff488f16dd6900a9bcb17d27584b4caaa4e2/README.md) · [architecture](https://github.com/CasterlyGit/emergency-ai/blob/0cadff488f16dd6900a9bcb17d27584b4caaa4e2/ARCHITECTURE.md) · [tests](https://github.com/CasterlyGit/emergency-ai/tree/0cadff488f16dd6900a9bcb17d27584b4caaa4e2/tests) |
...
| Shed | Verification repair active | [PR #37](https://github.com/CasterlyGit/shed/pull/37) restores the inherited test/Ruff baseline. Documentation [PR #35](https://github.com/CasterlyGit/shed/pull/35) remains dependent on that supported CI result. |
| emergency-ai | Verification repair queued | The architecture and test suite are public, but the current default-branch CI fails under supported Python versions at the synchronous/async event-loop boundary. Repair is tracked in [#12](https://github.com/CasterlyGit/emergency-ai/issues/12) before presentation work. |
