...
| Version progression | Active | Every flagship has an audited current version stage, repository-appropriate release policy, next eligible milestone, release-note expectation, and proof gate. Existing mismatches are repaired without rewriting history. | [#16](https://github.com/CasterlyGit/CasterlyGit/issues/16) · [Shed lineage correction #19](https://github.com/CasterlyGit/CasterlyGit/issues/19) · [delivery ledger](DELIVERY.md) |
...
| Flagship control plane | Complete for repositioning | Cognitive Development OS now has a source-backed evaluator path and conservative privacy/scope defaults while retaining its bounded dry-run status. Further product execution is separately owned. | [Cognitive Development OS #15](https://github.com/CasterlyGit/cognitive-development-os/issues/15) · [PR #27](https://github.com/CasterlyGit/cognitive-development-os/pull/27) · [PR #28](https://github.com/CasterlyGit/cognitive-development-os/pull/28) |
| Trident developer-tool trust signal | Active post-release evidence | The live demo, mechanics, acceptance gates, and CI remain current; [PR #15](https://github.com/CasterlyGit/trident/pull/15) records the next release gate and awaits its CI result. | [Trident #5](https://github.com/CasterlyGit/trident/issues/5) · [PR #9](https://github.com/CasterlyGit/trident/pull/9) · [PR #10](https://github.com/CasterlyGit/trident/pull/10) · [PR #12](https://github.com/CasterlyGit/trident/pull/12) · [PR #13](https://github.com/CasterlyGit/trident/pull/13) · [PR #15](https://github.com/CasterlyGit/trident/pull/15) |
| Shed trust signal | Complete | Ruff, release-guard, and deterministic test baselines are green; the README exposes current behavior, local/human-review boundaries, setup effects, verification, and bounded benchmark evidence. The non-monotonic release lineage and prospective gate are explicit. | [Shed #33](https://github.com/CasterlyGit/shed/issues/33) · [PR #37](https://github.com/CasterlyGit/shed/pull/37) · [PR #39](https://github.com/CasterlyGit/shed/pull/39) · [PR #40](https://github.com/CasterlyGit/shed/pull/40) · [PR #42](https://github.com/CasterlyGit/shed/pull/42) |
