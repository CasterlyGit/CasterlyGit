...
| Developer-tool trust signals | Active | Improve source-backed evaluation paths for Trident, Shed, and agent-harness: current behavior, boundaries, setup, and verification. | [Trident #5](https://github.com/CasterlyGit/trident/issues/5) · [Trident #6](https://github.com/CasterlyGit/trident/issues/6) · [Shed #33](https://github.com/CasterlyGit/shed/issues/33) · [agent-harness #1](https://github.com/CasterlyGit/agent-harness/issues/1) |
